...
public class UserController {
    ...
    @PostMapping
    public UserDto createUser(@RequestBody @Valid UserDto userDto, HttpServletRequest request) throws ValidationException, ThrowableException {
    ...
    public UserDto updateUser(@RequestBody @Valid UserDto userDto, HttpServletRequest request, @PathVariable Long userId) throws ValidationException, ThrowableException {
        log.debug("Получен {} запрос {} тело запроса: {}", request.getMethod(), request.getRequestURI(), userDto);
