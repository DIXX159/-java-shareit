...
class ItemServiceImplTest {
    ...
    void createItem_whenItemCreated_thenItemSave() {
        ...
        ItemDto actualItem = itemService.createItem(item, 1L);
    ...
    void createItem_whenAvailableIsNull_thenValidationExceptionThrown() {
        ...
        assertThrows(ValidationException.class, () -> itemService.createItem(item, 1L));
    ...
    void createItem_whenUserIdIs0_thenThrowableExceptionThrown() {
        ...
        assertThrows(ThrowableException.class, () -> itemService.createItem(item, 0L));
        verify(itemRepository, never()).save(item);
    }
    ...
    void createItem_whenItemIsExist_thenThrowableExceptionThrown() {
        ...
        assertThrows(ThrowableException.class, () -> itemService.createItem(item, 1L));
        verify(itemRepository, never()).save(item);
    }
    ...
    void updateItem_whenItemUpdated_thenItemSave() {
        ...
        itemService.updateItem(1L, item, 1L);
    ...
    void updateItem_whenUserIsNotOwner_thenNotFoundExceptionThrown() {
        ...
        assertThrows(NotFoundException.class, () -> itemService.updateItem(1L, item, 2L));
        verify(itemRepository, never()).save(item);
    }
    ...
    void updateItem_whenUserIdIs0_thenThrowableExceptionThrown() {
        ...
        assertThrows(ThrowableException.class, () -> itemService.updateItem(1L, item, 0L));
        verify(itemRepository, never()).save(item);
    }
    ...
    void updateItem_whenItemNotFound_thenNotFoundExceptionThrown() {
        ...
        assertThrows(NotFoundException.class, () -> itemService.updateItem(1L, item, 1L));
        verify(itemRepository, never()).save(item);
    }
    ...
    void createComment_whenBookingNotEnd_thenValidationExceptionThrown() {
        ...
        assertThrows(ValidationException.class, () -> itemService.createComment(comment, 1L, 1L));
    ...
    void createComment_whenItemNotFound_thenNotFoundExceptionThrown() {
        ...
        assertThrows(NotFoundException.class, () -> itemService.createComment(comment, 1L, 1L));
        verify(commentRepository, never()).save(comment);
    }
