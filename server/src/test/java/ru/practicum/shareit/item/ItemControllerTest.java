...
class ItemControllerTest {
    ...
    void updateItem() {
        ...
        ItemDto response = itemService.updateItem(1L, itemDto, 1L);
    ...
    void createComment() {
        ...
        when(itemService.createComment(commentDto, 1L, 1L))
                .thenReturn(commentDto);
        CommentDto response = itemService.createComment(commentDto, 1L, 1L);
